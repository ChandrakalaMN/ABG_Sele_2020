...
{	
	...
	public void test() throws Exception 
	{
		...
		for (int k = 1; k <= 100; k++)
		{
			Budget_GUI_CreateRentals avis = new Budget_GUI_CreateRentals();
			ReadWriteExcel rwe = new ReadWriteExcel("C:\\Avis_GUI_Automation\\Budget\\BUDGET_GUITestData_Rental_CheckOut.xlsx");
			...
			if (file.isDirectory()) {
			    ...
			    System.out.println(" iteration " + k);
				 String TCName 	= rwe.getCellData("Budget_GUI_Rentals", k, 4);
				 String clientURL   	= rwe.getCellData("Budget_GUI_Rentals", k, 7);
				 String outSTA      	= rwe.getCellData("Budget_GUI_Rentals", k, 10);
				 String thinClient  	= clientURL+outSTA;
				 String uName       	= rwe.getCellData("Budget_GUI_Rentals", k, 8);
				 String pswd        	= rwe.getCellData("Budget_GUI_Rentals", k, 9);
				 String ResNo      		= rwe.getCellData("Budget_GUI_Rentals", k, 11);
				 String CustType		= rwe.getCellData("Budget_GUI_Rentals", k, 12);
				 String WizardNo		= rwe.getCellData("Budget_GUI_Rentals", k, 13);
				 String LastName		= rwe.getCellData("Budget_GUI_Rentals", k, 14);
				 String FirstName		= rwe.getCellData("Budget_GUI_Rentals", k, 15);
				 String COCountry 		= rwe.getCellData("Budget_GUI_Rentals", k, 16);
				 String COState			= rwe.getCellData("Budget_GUI_Rentals", k, 17);
				 String CODRLICNO 		= rwe.getCellData("Budget_GUI_Rentals", k, 18);
				 String CODOB			= rwe.getCellData("Budget_GUI_Rentals", k, 19);
				 String COCOMPANY		= rwe.getCellData("Budget_GUI_Rentals", k, 20);
				 String COADDR1			= rwe.getCellData("Budget_GUI_Rentals", k, 21);
				 String COADDR2			= rwe.getCellData("Budget_GUI_Rentals", k, 22);
				 String COADDR3			= rwe.getCellData("Budget_GUI_Rentals", k, 23);
				 String COCONTACTINFO   = rwe.getCellData("Budget_GUI_Rentals", k, 24);
				 String COEMAIL			= rwe.getCellData("Budget_GUI_Rentals", k, 25);
				 String COMOP			= rwe.getCellData("Budget_GUI_Rentals", k, 26);
				 String COCCDC			= rwe.getCellData("Budget_GUI_Rentals", k, 27);
				 String CARDNO			= rwe.getCellData("Budget_GUI_Rentals", k, 28);
				 String COMM			= rwe.getCellData("Budget_GUI_Rentals", k, 29);
				 String COYY			= rwe.getCellData("Budget_GUI_Rentals", k, 30);
				 String MOPREASON		= rwe.getCellData("Budget_GUI_Rentals", k, 31);
				 String RETURNSTATION	= rwe.getCellData("Budget_GUI_Rentals", k, 32);
				 String RETURNDATE		= rwe.getCellData("Budget_GUI_Rentals", k, 33);
				 String RETURNTIME		= rwe.getCellData("Budget_GUI_Rentals", k, 34);
				 String CARGROUP		= rwe.getCellData("Budget_GUI_Rentals", k, 35);
				 String AWD				= rwe.getCellData("Budget_GUI_Rentals", k, 36);
				 String COUPON			= rwe.getCellData("Budget_GUI_Rentals", k, 37);
				 String FTNTYPE			= rwe.getCellData("Budget_GUI_Rentals", k, 38);
				 String FTNUMBER		= rwe.getCellData("Budget_GUI_Rentals", k, 39);
				 String REMARKS			= rwe.getCellData("Budget_GUI_Rentals", k, 40);
				 String COMVA			= rwe.getCellData("Budget_GUI_Rentals", k, 41);
				 String COMILEAGE		= rwe.getCellData("Budget_GUI_Rentals", k, 42);
				 String INSURANCE		= rwe.getCellData("Budget_GUI_Rentals", k, 43);
				 String COUNTERPRODUCT	= rwe.getCellData("Budget_GUI_Rentals", k, 44);
				 String ADRLASTNAME		= rwe.getCellData("Budget_GUI_Rentals", k, 45);
				 String ADRFIRSTNAME	= rwe.getCellData("Budget_GUI_Rentals", k, 46);
				 String ADRDOB			= rwe.getCellData("Budget_GUI_Rentals", k, 47);
				 String ADRCOUNTRY		= rwe.getCellData("Budget_GUI_Rentals", k, 48);
				 String ADRSTATE		= rwe.getCellData("Budget_GUI_Rentals", k, 49);
				 String ADRDRLICNO		= rwe.getCellData("Budget_GUI_Rentals", k, 50);
				 String ADREXPMM		= rwe.getCellData("Budget_GUI_Rentals", k, 51);
				 String ADREXPYY		= rwe.getCellData("Budget_GUI_Rentals", k, 52);
				 String ADRADDR1		= rwe.getCellData("Budget_GUI_Rentals", k, 53);
				 String ADRADDR2		= rwe.getCellData("Budget_GUI_Rentals", k, 54);
				 String ADRADDR3		= rwe.getCellData("Budget_GUI_Rentals", k, 55);
				 String ADRTELEPHONE1	= rwe.getCellData("Budget_GUI_Rentals", k, 56);
				 String ADRTELEPHONE2   = rwe.getCellData("Budget_GUI_Rentals", k, 57);
				 String ADRCCDC			= rwe.getCellData("Budget_GUI_Rentals", k, 58);
				 String ADRCARDNO		= rwe.getCellData("Budget_GUI_Rentals", k, 59);
				 String ADRCCEXPMM		= rwe.getCellData("Budget_GUI_Rentals", k, 60);
				 String ADRCCEXPYY		= rwe.getCellData("Budget_GUI_Rentals", k, 61);
